...
public class ProductBuyInterFrm extends javax.swing.JInternalFrame {
	...
	private javax.swing.JButton jb_viewComment;
...
jb_viewComment=new javax.swing.JButton();
...
jb_delete.setIcon(new javax.swing.ImageIcon("./images/delete.png")); 
jb_delete.setText("删除该已选择商品");
...
jb_cost.setIcon(new javax.swing.ImageIcon("./images/money.png")); 
jb_cost.setText("结算");
...
jb_viewComment.setText("查看该商品评论");
jb_viewComment.addActionListener(new ActionListener() {
public void actionPerformed(ActionEvent evt) {
openComment(evt);
}

private void openComment(ActionEvent evt) {
	// TODO 自动生成的方法存根
	评论 A=new 评论();
	A.setVisible(true);
}
